...
- **Radiator performance:** The thermal problem splits cleanly by phase. During acceleration, the propellant itself handles engine cooling — regenerative cooling passes propellant through engine structure before exhaust, absorbing waste heat that then exits with the plasma. No radiator required during the acceleration burn; the cooling mechanism is the propulsion mechanism. During deceleration the heat load is an order of magnitude lower — 20-40 years at low thrust produces far less heat per unit time than the acceleration phase. Static radiators sized only for the deceleration heat load are substantially smaller and lighter than radiators sized for peak acceleration load. The radiator mass assumption is less problematic than it first appeared. What remains uncertain is the specific radiator performance required for the deceleration phase, which depends on the fusion drive architecture selected.
