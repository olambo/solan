...
The quoted 1,000 tonne figure refers to estimated cruise mass, not initial launch mass. After acceleration burn completion and propellant expenditure, the Voidfarer is expected to retain approximately 1,000 tonnes at transit velocity. Initial departure mass would necessarily be higher, likely exceeding 2,000 tonnes depending on propulsion configuration. Kinetic energy estimates use the cruise mass value. Of the 1,000 tonne cruise mass, roughly half is deceleration propellant — the VoidForge separates at the destination and goes to work at approximately 150-200 tonnes, with the hull and tank structure (~300 tonnes) becoming the first material inventory of the new Solan Node. A verified mass budget has not been derived; the propellant fraction depends on exhaust velocity assumptions that require a specific drive architecture to calculate. 1,000 tonnes cruise mass is a working estimate, not an engineering result. Unless otherwise specified, quoted Voidfarer mass figures refer to cruise mass: the retained vehicle mass at interstellar transit velocity after completion of the primary acceleration phase.

**Physical scale**

The ship runs approximately 400 metres in length. The length is not an aesthetic choice — it is propellant. At launch the Voidfarer carries roughly 1,450 tonnes of cryogenic fusion fuel: approximately 950 tonnes for acceleration and 500 tonnes for deceleration at the destination. The spine is primarily tanks. Strip out the propellant and the ship shrinks dramatically — what remains is the shield, the VoidForge, and structure. The correct mental model is a 400-metre propellant vessel with a shield at one end and a civilisation-building engine at the other.
