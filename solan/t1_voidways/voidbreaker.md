...
*Verified design parameters: see [Voidbreaker Design Baseline]({{< ref "voidbreaker-baseline" >}})*
...
See [Voidbreaker Design Baseline]({{< ref "voidbreaker-baseline" >}}) for the verified calculation.
...
![Voidbreaker](/images/grok-voidfarer.png)
